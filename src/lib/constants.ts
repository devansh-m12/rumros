...
export const AUTH_TOKEN = 'rumros.auth';
export const LOCALE_CONFIG = 'rumros.locale';
export const TIMEZONE_CONFIG = 'rumros.timezone';
export const DATE_RANGE_CONFIG = 'rumros.date-range';
export const THEME_CONFIG = 'rumros.theme';
export const DASHBOARD_CONFIG = 'rumros.dashboard';
export const VERSION_CHECK = 'rumros.version-check';
export const SHARE_TOKEN_HEADER = 'x-umami-share-token';
export const HOMEPAGE_URL = 'https://rumros.com';
